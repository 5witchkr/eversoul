<div class="hero min-h-screen bg-base-200">
    <div class="hero-content text-center">
      <div class="flex flex-col w-full">
        <div class="hero min-h-100vh" style="background-image: url(https://eversoul.kakaogames.com/images/media/wallpaper/img-detail7.jpg);">
          <div class="hero-overlay bg-opacity-60"></div>
          <div class="hero-content text-center text-neutral-content">
            <div class="max-w-md">
              <h1 class="mb-40 text-5xl font-bold"></h1>
              <div class="mb-5"></div>
            </div>
          </div>
        </div>
